...
bool imc_ros_msgs__msg__remote_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("imc_ros_msgs.msg._remote_state.RemoteState", full_classname_dest, 42) == 0);
  }
  imc_ros_msgs__msg__RemoteState * ros_message = _ros_message;
  {  // lat
  ...
  {  // depth
    ...
    ros_message->depth = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // speed
...
{
  /* NOTE(esteve): Call constructor of RemoteState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("imc_ros_msgs.msg._remote_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RemoteState");
