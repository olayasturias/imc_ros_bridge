...
class Metaclass_PlanDBInformation(type):
    """Metaclass of message 'PlanDBInformation'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__plan_db_information
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__plan_db_information
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__plan_db_information
            cls._TYPE_SUPPORT = module.type_support_msg__msg__plan_db_information
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__plan_db_information
...
class PlanDBInformation(metaclass=Metaclass_PlanDBInformation):
    """Message class 'PlanDBInformation'."""
    ...
    def plan_size(self, value):
        if __debug__:
            ...
            assert value >= 0 and value < 65536, \
                "The 'plan_size' field must be an unsigned integer in [0, 65535]"
