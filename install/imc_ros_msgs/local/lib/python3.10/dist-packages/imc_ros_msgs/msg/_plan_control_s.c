...
bool imc_ros_msgs__msg__plan_control__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("imc_ros_msgs.msg._plan_control.PlanControl", full_classname_dest, 42) == 0);
  }
  imc_ros_msgs__msg__PlanControl * ros_message = _ros_message;
  {  // type
...
{
  /* NOTE(esteve): Call constructor of PlanControl */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("imc_ros_msgs.msg._plan_control");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PlanControl");
