...
#include "imc_ros_msgs/msg/detail/plan_db_information__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const imc_ros_msgs::msg::PlanDBInformation & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  imc_ros_msgs::msg::PlanDBInformation & ros_message)
{
  // Member: plan_id
  cdr >> ros_message.plan_id;
...
{
  auto typed_message =
    static_cast<const imc_ros_msgs::msg::PlanDBInformation *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<imc_ros_msgs::msg::PlanDBInformation *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _PlanDBInformation__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const imc_ros_msgs::msg::PlanDBInformation *>(
...
static size_t _PlanDBInformation__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_PlanDBInformation(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _PlanDBInformation__callbacks = {
  "imc_ros_msgs::msg",
  "PlanDBInformation",
...
static rosidl_message_type_support_t _PlanDBInformation__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_PlanDBInformation__callbacks,
...
{
  return &imc_ros_msgs::msg::typesupport_fastrtps_cpp::_PlanDBInformation__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, imc_ros_msgs, msg, PlanDBInformation)() {
  return &imc_ros_msgs::msg::typesupport_fastrtps_cpp::_PlanDBInformation__handle;
}
