...
#include "imc_ros_msgs/msg/detail/plan_control_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const imc_ros_msgs::msg::PlanControlState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  imc_ros_msgs::msg::PlanControlState & ros_message)
{
  // Member: state
  cdr >> ros_message.state;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_imc_ros_msgs
max_serialized_size_PlanControlState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const imc_ros_msgs::msg::PlanControlState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<imc_ros_msgs::msg::PlanControlState *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _PlanControlState__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const imc_ros_msgs::msg::PlanControlState *>(
...
static size_t _PlanControlState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_PlanControlState(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _PlanControlState__callbacks = {
  "imc_ros_msgs::msg",
  "PlanControlState",
...
static rosidl_message_type_support_t _PlanControlState__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_PlanControlState__callbacks,
...
{
  return &imc_ros_msgs::msg::typesupport_fastrtps_cpp::_PlanControlState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, imc_ros_msgs, msg, PlanControlState)() {
  return &imc_ros_msgs::msg::typesupport_fastrtps_cpp::_PlanControlState__handle;
}
