...
bool imc_ros_msgs__msg__polygon_vertex__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("imc_ros_msgs.msg._polygon_vertex.PolygonVertex", full_classname_dest, 46) == 0);
  }
  imc_ros_msgs__msg__PolygonVertex * ros_message = _ros_message;
  {  // lat
...
{
  /* NOTE(esteve): Call constructor of PolygonVertex */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("imc_ros_msgs.msg._polygon_vertex");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PolygonVertex");
