...
bool imc_ros_msgs__msg__sonar_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("imc_ros_msgs.msg._sonar_data.SonarData", full_classname_dest, 38) == 0);
  }
  imc_ros_msgs__msg__SonarData * ros_message = _ros_message;
  {  // type
  ...
  {  // min_range
    ...
    assert(PyLong_Check(field));
    ros_message->min_range = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // max_range
    ...
    assert(PyLong_Check(field));
    ros_message->max_range = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // bits_per_point
    PyObject * field = PyObject_GetAttrString(_pymsg, "bits_per_point");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->bits_per_point = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // scale_factor
...
{
  /* NOTE(esteve): Call constructor of SonarData */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("imc_ros_msgs.msg._sonar_data");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SonarData");
  ...
  {  // bits_per_point
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->bits_per_point);
    {
      int rc = PyObject_SetAttrString(_pymessage, "bits_per_point", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
