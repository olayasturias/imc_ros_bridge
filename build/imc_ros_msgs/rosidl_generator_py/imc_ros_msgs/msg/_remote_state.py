...
class Metaclass_RemoteState(type):
    """Metaclass of message 'RemoteState'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'imc_ros_msgs.msg.RemoteState')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__remote_state
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__remote_state
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__remote_state
            cls._TYPE_SUPPORT = module.type_support_msg__msg__remote_state
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__remote_state
...
class RemoteState(metaclass=Metaclass_RemoteState):
    """Message class 'RemoteState'."""
    ...
    def depth(self, value):
        if __debug__:
            ...
            assert value >= 0 and value < 256, \
                "The 'depth' field must be an unsigned integer in [0, 255]"
        self._depth = value
