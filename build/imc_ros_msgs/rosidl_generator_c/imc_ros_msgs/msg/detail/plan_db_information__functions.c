...
imc_ros_msgs__msg__PlanDBInformation__init(imc_ros_msgs__msg__PlanDBInformation * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->plan_id)) {
    imc_ros_msgs__msg__PlanDBInformation__fini(msg);
    return false;
  }
  // plan_size
  // change_time
...
imc_ros_msgs__msg__PlanDBInformation__create()
{
  ...
  imc_ros_msgs__msg__PlanDBInformation * msg = (imc_ros_msgs__msg__PlanDBInformation *)allocator.allocate(sizeof(imc_ros_msgs__msg__PlanDBInformation), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(imc_ros_msgs__msg__PlanDBInformation));
  bool success = imc_ros_msgs__msg__PlanDBInformation__init(msg);
  if (!success) {
...
imc_ros_msgs__msg__PlanDBInformation__Sequence__init(imc_ros_msgs__msg__PlanDBInformation__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  imc_ros_msgs__msg__PlanDBInformation * data = NULL;

  if (size) {
    data = (imc_ros_msgs__msg__PlanDBInformation *)allocator.zero_allocate(size, sizeof(imc_ros_msgs__msg__PlanDBInformation), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = imc_ros_msgs__msg__PlanDBInformation__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        imc_ros_msgs__msg__PlanDBInformation__fini(&data[i - 1]);
      }
...
imc_ros_msgs__msg__PlanDBInformation__Sequence__fini(imc_ros_msgs__msg__PlanDBInformation__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      imc_ros_msgs__msg__PlanDBInformation__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  imc_ros_msgs__msg__PlanDBInformation__Sequence * array = (imc_ros_msgs__msg__PlanDBInformation__Sequence *)allocator.allocate(sizeof(imc_ros_msgs__msg__PlanDBInformation__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = imc_ros_msgs__msg__PlanDBInformation__Sequence__init(array, size);
  if (!success) {
...
imc_ros_msgs__msg__PlanDBInformation__Sequence__destroy(imc_ros_msgs__msg__PlanDBInformation__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    imc_ros_msgs__msg__PlanDBInformation__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
imc_ros_msgs__msg__PlanDBInformation__Sequence__are_equal(const imc_ros_msgs__msg__PlanDBInformation__Sequence * lhs, const imc_ros_msgs__msg__PlanDBInformation__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!imc_ros_msgs__msg__PlanDBInformation__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  imc_ros_msgs__msg__PlanDBInformation__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(imc_ros_msgs__msg__PlanDBInformation);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    imc_ros_msgs__msg__PlanDBInformation * data =
      (imc_ros_msgs__msg__PlanDBInformation *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!imc_ros_msgs__msg__PlanDBInformation__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          imc_ros_msgs__msg__PlanDBInformation__fini(&output->data[i]);
        }
        return false;
      }
    }
