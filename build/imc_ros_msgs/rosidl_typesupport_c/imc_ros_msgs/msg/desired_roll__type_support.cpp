...
static const _DesiredRoll_type_support_symbol_names_t _DesiredRoll_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, imc_ros_msgs, msg, DesiredRoll)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, imc_ros_msgs, msg, DesiredRoll)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, imc_ros_msgs, msg, DesiredRoll)() {
  return &::imc_ros_msgs::msg::rosidl_typesupport_c::DesiredRoll_message_type_support_handle;
}
